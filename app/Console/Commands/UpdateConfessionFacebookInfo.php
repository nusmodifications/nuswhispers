...
class UpdateConfessionFacebookInfo extends Command
{
    ...
    public function handle()
    {
        ...
        $facebookRequest = sprintf('/%s/feed?limit=250&oauth_token=%s&fields=comments.limit(1).summary(true),likes.limit(1).summary(true)', config('services.facebook.page_id'), $accessToken);
